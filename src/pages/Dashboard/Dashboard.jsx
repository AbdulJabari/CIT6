...
import { FaBookOpen, FaClock, FaEye, FaMedal } from 'react-icons/fa'
  ...
  return (
    <div className="mt-20 ml-8 w-auto h-full overflow-x-hidden gap-x-0">
      ...
      <div className="flex relative">
        <div className=" w-[25%] h-[120vh] bg-gray-200 rounded-lg flex flex-col gap-y-6  item-start text-lg font-bold sticky top-0">
          <h3 className=" ml-6 mt-7 flex items-center gap-1">
